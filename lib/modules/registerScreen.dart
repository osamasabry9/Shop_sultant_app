...
import 'package:Shopsultant/cubit/signInCubit.dart';
                      ...
                      [
                        Row(
                          children: [
                            ...
                            Text('ShopSultant',style: TextStyle(fontSize: 20),),
                            Spacer(),
                            IconButton(
                                onPressed: ()
                                {
                        ...
                        Text('Create a Shopsultant account',style: TextStyle(fontSize: 20,),),
                        SizedBox(height: 30,),
                        defaultFormField(
                            context: context,
                            controller: name,
