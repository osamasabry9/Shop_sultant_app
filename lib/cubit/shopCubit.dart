...
import 'package:Shopsultant/models/addressModels/addAddressModel.dart';
import 'package:Shopsultant/models/addressModels/addressModel.dart';
import 'package:Shopsultant/models/addressModels/update&Delete.dart';
import 'package:Shopsultant/models/cartModels/addCartModel.dart';
import 'package:Shopsultant/models/cartModels/cartModel.dart';
import 'package:Shopsultant/models/categoriesModels/categoriesDetailsModel.dart';
import 'package:Shopsultant/models/categoriesModels/categoriesModel.dart';
import 'package:Shopsultant/models/favoritesModels/changeFavoritesModel.dart';
import 'package:Shopsultant/models/favoritesModels/favoritesModel.dart';
import 'package:Shopsultant/models/homeModels/productModel.dart';
import 'package:Shopsultant/models/profileModels/faqsModels.dart';
import 'package:Shopsultant/models/homeModels/homeModel.dart';
import 'package:Shopsultant/models/cartModels/updateCartModel.dart';
import 'package:Shopsultant/models/profileModels/userModel.dart';
import 'package:Shopsultant/modules/CategoriesScreen.dart';
import 'package:Shopsultant/modules/cartScreen.dart';
import 'package:Shopsultant/modules/homeScreen.dart';
import 'package:Shopsultant/modules/myAccountScreen.dart';
  ...
  Widget topSheet(model,context)
  {
    if(inCart) {
      return MaterialBanner(
          ...
          leading: Icon(Icons.check_circle, color: Colors.deepOrange, size: 30,),
          content: Column(
